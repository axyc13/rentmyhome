                        ...
                        <div className="space-y-2">
                          ...
                          <label className="flex items-start gap-3 rounded-xl border border-gray-200 bg-white p-4">
                            ...
                            <span className="text-sm text-gray-700">
                              ...
                              fill the following landlord details.
                            </span>
                          </label>
                        </div>
...
function StepHeader({
  ...
  return (
    <div className="grid gap-4 rounded-2xl border border-gray-200 bg-gray-50 p-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start">
      <div>
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 lg:justify-end lg:self-center lg:pb-0">
